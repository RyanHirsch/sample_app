...
describe User do
  ...
  describe "when the email format is invalid" do
    it "should be invalid" do
      addresses = %w[user@foo,com user@bar_baz.org user@bar+baz.org user_at_foo.org example.user@foo.]
  ...
  describe "when the email format is valid" do
    it "should be valid" do
      addresses = %w[user@foo.com USER@b.foo.org example.user@foo.jp a+b@baz.cn]
